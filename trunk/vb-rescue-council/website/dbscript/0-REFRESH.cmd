...
c:\cygwin\bin\sed --file=%USERPROFILE%\Documents\script\scrub-mysqldump-for-refresh-%1.sed %USERPROFILE%\my-documents\SANDBOX\vocational\kalipso-infogistics\db-dump\%base_db_name%.sql | mysql --host=%the_host% --user=%the_user% --password=%2 --database=%db_instance%
