    ...
    public partial class TWebUserControl_role_member_matrix: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_PlaceHolder_content"] as string) == "UserControl_role_member_matrix");
            }
            else
            {
        ...
        private void Bind()
        {
            ...
            uint i;
            p.biz_role_member_map.Bind(p.sort_order, p.be_sort_order_ascending, GridView_control, out p.crosstab_metadata_rec_arraylist);
