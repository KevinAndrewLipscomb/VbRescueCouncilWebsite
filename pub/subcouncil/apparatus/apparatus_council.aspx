<!DOCTYPE html>
<%@ Page language="c#" codebehind="apparatus_council.aspx.cs" AutoEventWireup="True" Inherits="apparatus_council.TWebForm_apparatus_council" %>
<%@ Register TagPrefix="uc1" TagName="UserControl_precontent" Src="~/usercontrol/app/UserControl_precontent.ascx" %>
<%@ Register TagPrefix="uc1" TagName="UserControl_postcontent" Src="~/usercontrol/app/UserControl_postcontent.ascx" %>
<html>
  <head runat="server">
    <!-- $Id: apparatus_council.aspx 7117 2020-05-06 00:00:59Z kevinanlipscomb $ -->
    <title></title>
